...
local Theme = {
    ...
    EnterBase = Color3.fromRGB(45, 120, 220), -- Цвет для Enter Base
    ExitBase = Color3.fromRGB(220, 80, 80)   -- Цвет для Exit Base
}
...
-- Enter Base button
local EnterBaseBtn = CreateButton(BypassContent, "Enter Base", function()
    smoothVerticalMove(DOWN_DISTANCE, -1)
    notify("Enter Base", "Moving down", "info")
end, 4, "Q")
EnterBaseBtn.BackgroundColor3 = Theme.EnterBase
AddHover(EnterBaseBtn, Theme.EnterBase, Color3.fromRGB(60, 140, 240))

-- Exit Base button
local ExitBaseBtn = CreateButton(BypassContent, "Exit Base", function()
    smoothVerticalMove(UP_DISTANCE, 1)
    notify("Exit Base", "Moving up", "info")
end, 5, "R")
ExitBaseBtn.BackgroundColor3 = Theme.ExitBase
...
applyBtn.ZIndex = 21
applyBtn.Parent = PetFilterContent
...
clearBtn.ZIndex = 21
clearBtn.Parent = PetFilterContent
